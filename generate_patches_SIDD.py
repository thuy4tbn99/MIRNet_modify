...
parser.add_argument('--src_dir', default='../data/SIDD_Medium_Srgb/Data', type=str, help='Directory for full resolution images')
...
def save_files(i):
    ...
    print("clean_img", type(clean_img))
...
#------------------------------------
# test code
# for i in tqdm(range(len(noisy_files))):
#     if i<76:
#         continue
#     print('i:', i)
#     save_files(i)